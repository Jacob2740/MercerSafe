    ...
    Set<Marker> getmarkers() { //markers to place on map
        setState(() {
            markers.add(Marker( //add first marker
              ...
              position: LatLng(32.82984595040604, -83.6520853375285), //position of marker
            ...
            markers.add(Marker( //add second marker
              ...
              position: LatLng(32.83004321110057, -83.65261243975954), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.82925359076843, -83.65339173434724), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.82904145158433, -83.65424828236657), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.831523507231616, -83.65093437847436), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.831575971404824, -83.65177923923646), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.83233345038014, -83.65114129750334), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.828325624244656, -83.65200174214068), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.82865694055968, -83.65218413234626), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.828801186732385, -83.65278494714116), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.82734934530236, -83.65412982859912), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.83644572101392, -83.64756259227318), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
            ...
            markers.add(Marker( //add third marker
              ...
              position: LatLng(32.837030274137256, -83.64761721395841), //position of marker
              infoWindow: InfoWindow( //popup info 
                title: 'Emergency Blue Light Station',
